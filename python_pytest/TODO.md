...
- [x] 100円コインを投入しないでボタンを押してもコーラは出ない
- [x] 押したボタンに応じてコーラかウーロン茶が出ます。
- [x] 200円入れるとレッドブルも買えます
- [x] 100円入れてもレッドブルは買えない
- [x] 100円コインの他に、10円、50円、500円コインも使えます。
- [x] 投入した合計金額が分かる
- [x] 投入した合計金額を変更できない
- [x] ボタンを押して飲み物を買うと、お釣りが出ます。
- [x] ボタンを押して飲み物を買うと、残額がゼロになる
- [x] 返却ボタンを押すと投入したお金が戻ってくる
- [x] 最初はお釣り入れは空っぽ
- [ ] テストを整理し充実する
- [ ] 100円コインを投入してもボタンを押さないとコーラは出ない
- [ ] 出たコーラを取り除ける
- [ ] コーラが出ている状態でボタンを押してもコーラは出ない
